...
<div class=" dashboard site-card " id="transaction_form"> <br>
    <div class=" dashboard-body mt-0 p-4 ">
        <form action="#" class="mx-auto" style="max-width: 650px" id="payment_details_form" autocomplete="off"
            ...
            <div class="mb-2">
                <ul class="nav w-100 active position-relative nav-fill nav-pills" id="onetime_bene_tab" role="tablist">
            ...
            <div class="tab-content" id="onetime_bene_tabContent">
                ...
                <div class="tab-pane py-3 px-0 fade show active" id="beneficiary_view" role="tabpanel"
                    ...
                    <div class="col-12">
                        ...
                        @if ($currentPath === 'Local Bank' || $currentPath === 'International Bank' || $currentPath ===
                        'Standing Order')
                        <div class="form-group align-items-center row bank_div">
                            <label class="text-primary  col-md-4">{{ $destination }} Bank</label>
                            <input class="form-control  text-input col-md-8 display_to_account display_to_account_bank "
                        ...
                        <div class="row align-items-center mb-1">
                            ...
                            <input class="form-control  text-input col-md-8  " type="text" id="beneficiary_address"
                                disabled>
                        </div>
                        @endif
                    </div>
                ...
                @if ($currentPath === 'Local Bank' || $currentPath === 'Same Bank' || $currentPath === 'International
                Bank')
                <div class="tab-pane py-3 px-0 fade" id="onetime_view" role="tabpanel" aria-labelledby="onetime_tab">
                    <div class="col-12">
                        @if ($currentPath === 'International Bank')
                        <div class="row align-items-center mb-1">
                            <label class="text-primary col-md-4">Bank Country</label>
                            <div class="px-0 col-md-8"> <select class="form-control " id="onetime_select_country"
                                    required>
                        ...
                        <div class="form-group align-items-center row">
                            <label class="col-md-4 text-primary"> Beneficiary A/C
                                Number</label>
                            <input type="text" class="form-control  text-input col-md-8 " id="onetime_account_number"
                        ...
                        <div class="form-group align-items-center row">
                            ...
                            <div class="input-group px-0 col-md-8" style="position: relative">
                                ...
                                <span class="spinner-grow-sm input-span  spinner-grow text-rokel-blue" role="status"
                                    id="onetime_beneficiary_name_loader" style="display: none">
                        ...
                        <div class="form-group align-items-center row">
                            ...
                            <input type="text" class="form-control text-input col-md-8 " id="onetime_beneficiary_email"
            ...
            <div class="col-12">
                ...
                <div class="form-group align-items-center row">
                    ...
                    <div class="input-group mb-1 col-md-8" style="padding: 0px;">
                        ...
                        &nbsp;&nbsp;
                        <input type="text" class="form-control text-input  " placeholder="Enter Amount To Transfer"
                            id="amount"
                            oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')"
                            required>
                ...
                <div class="form-group align-items-center row mb-3">
                    ...
                    <input type="date" class="form-control text-input col-md-8" min="01-01-1997" max="31-12-2030"
                ...
                <div class="form-group align-items-center row">
                    ...
                    <div class="col-md-8 px-0"> <select class=" form-control  so_frequency" id="beneficiary_frequency"
