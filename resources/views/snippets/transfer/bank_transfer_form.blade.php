...
<div class=" dashboard site-card px-4 h-100 " id="transaction_form"> <br>
    <div class="container dashboard-body p-4 ">
                            ...
                            <div class="col-12">
                                @if ($currentPath === 'Standing Order')
                                    <div class="form-group align-items-center row">
                                        ...
                                        <div class="col-md-8 px-0"> <select class="form-control  "
                                                id="standing_other_type" required>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-md-8 px-0"> <select
                                            data-title=" --- Select {{ $destination }} ---"
                                ...
                                <div class="col-12">
                                    ...
                                    @if ($currentPath === 'Local Bank' || $currentPath === 'International Bank')
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-8 px-0"><select class="form-control "
                                                    id="onetime_select_bank" required>
                                                    <option disabled selected>--- Not Selected ---</option>
                                        ...
                                        <div class="form-group align-items-center row">
                                            ...
                                            <div class="input-group px-0 col-md-8" style="position: relative">
                                                <input type="text"
                                                    ...
                                                    placeholder="Beneficiary Name" id="onetime_beneficiary_name"
                                                    disabled>
                                    ...
                                    @if ($currentPath === 'Local Bank' || $currentPath === 'International Bank')
                                        <div class="row align-items-center mb-1">
                                            <label class="text-primary col-md-4">Beneficiary Address</label>
                                            <input class="form-control text-input col-md-8" type="text"
                                                id="onetime_beneficiary_address"
                        ...
                        <div class="form-group align-items-center row">
                            ...
                            <div class="input-group mb-1 col-md-8" style="padding: 0px;">
                                <div class="input-group-prepend">
                                    ...
                                    @endif
                                    @if ($currentPath === 'International Bank')
                                        <select class="" style="width: 100px;" id="transfer_currency"
                                            required>
