                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-1">
                                            ...
                                            <input type="text" id="first_name" class="form-control" autocomplete="off"
                                                aria-autocomplete="off" placeholder="Enter Agent First Name" required>
                                        </div>
                                        ...
                                        <div class="form-group mb-1">
                                            <label class="text-dark">Select Gender:<span
                                        ...
                                        <div class="form-group mb-1">
                                            <label class="text-dark">Telephone Number
                                                2:(optional)</label>
                                            <input type="text" id="telephone_number_2" class="form-control"
                                                maxlength="10"
                                        ...
                                        <div class="form-group mb-1 ">
                                            ...
                                            <input type="text" id="id_number" class="form-control" maxlength="10"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1')"
                                                autocomplete="off" aria-autocomplete="off"
                                        ...
                                        <div class="form-group mb-1">
                                            <label class="text-dark">Institution Name:<span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group mb-1 ">
                                            <label class="text-dark">Agent Region:<span
                                                    class="text-danger">*</span></label>
                                            ...
                                            @if (session()->get('UserMandate') == 'NationalLevel')
                                                <div class="d-flex align-items-center ml-1">
                                                    ...
                                                    <span class="spinner-border spinner-border-sm mr-1"
                                                        id="region_spinner" role="status" aria-hidden="true"
                                        ...
                                        <div class="form-group mb-1">
                                            ...
                                            @elseif(session()->get('UserMandate') == 'ConstituencyLevel')
                                                ...
                                                <select class="form-control col-md-7 ml-3" id="agent_constituency"
                                                    disabled style="background: #DCDCDC">
                                        ...
                                        <div class="form-group mb-1">
                                            ...
                                            <select class="form-control " id="agent_electoral_area">
