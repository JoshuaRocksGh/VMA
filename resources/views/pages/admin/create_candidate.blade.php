        ...
        document.getElementById("candidate_image").addEventListener("change", function(event) {
            ...
            if (file) {
                ...
                reader.onload = function(event) {
                    ...
                    const base64String_ = event.target.result.split(',')[1];
                    candidateData.candidateImage = base64String_
        ...
        document.getElementById("candidate_party_logo").addEventListener("change", function(event) {
            ...
            if (file) {
                ...
                reader.onload = function(event) {
                    ...
                    candidateData.candidatePartyLogo = base64String

                    //console.log('Base64 encoded file content:', base64String);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == "ok") {
                        toaster(response.message, "success", 6000)
                    } {
