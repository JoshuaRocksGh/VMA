                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <input type="text" class="form-control" id="user_first_name"
                                                                required placeholder="Enter User First Name"
                                                                autocomplete="off">
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <input type="date" class="form-control" id="user_dob"
                                                                required placeholder="Enter User Date of Birth"
                                                                autocomplete="off">
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <input type="text" class="form-control" id="user_last_name"
                                                                required placeholder="Enter User Last Name"
                                                                autocomplete="off">
                                                        </div>
                                        ...
                                        <div class="form-group mb-1" style="display: none">
                                            ...
                                            @if (session()->get('UserMandate') == 'NationalLevel')
                                                <select class="form-control" name="" id="user_mandate">
                                                    <option value="">-- Select User Mandate Level --
                                                    </option>
