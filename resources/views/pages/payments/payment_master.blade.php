        ...
        <nav class="dashboard-header">
            <div class="nav nav-tabs justify-content-center border-0" id="nav-tab" role="tablist">
                <a href="#send_{{ $currentType }}_page" data-toggle="tab" aria-expanded="true"
                    class="nav-link w-100 text-center mb-2 active send_{{ $currentType }}_tab" style="max-width: 175px">
                    Send {{ $currentPath }}
                </a>
        ...
        <div class="tab-content dashboard-body">
                ...
                <div class="mx-auto  h-100 " style="max-width: 650px" id="request_form_div">
                    <form action="#" class="select_beneficiary" id="send_{{ $currentType }}_payment_details_form"
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-5 text-primary align-self-center"> Type of
                                Transfer &nbsp; <span class="text-danger">*</span></label>

                            <div class="row col-sm-7 ml-3 ml-sm-0">
                                <div class="radio radio-primary form-check-inline m-1 col-sm-5 destination">
                                    <input type="radio" id="transfer_to_self" value="SELF" name="self_transfer_toggle">
                                    <label class="col-form-label ml-2" for="transfer_to_self"> Self
                                    </label>
                                </div>
                                <div class="radio  radio-primary form-check-inline m-1 col-sm-5 transfer_type">
            ...
            <div class="tab-pane" id="redeem_{{ $currentType }}_page">
                ...
                <div class="  pt-5 px-4 mx-auto " id="request_form_div" style="max-width: 650px">
                    ...
                    <form action="#" class="select_beneficiary" id="redeem_{{ $currentType }}_payment_details_form"
                        autocomplete="off" aria-autocomplete="none">
                        @csrf
                            ...
                            <div class="col-md-12 redeem_{{ $currentType }}">
                                ...
                                <div class=" form-group row">
                                    ...
                                    <input type="text" class="form-control col-md-7" id="remittance_no"
                                        placeholder="Enter Remittance Number" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '
                                    $1');" required>
                                </div>
                            ...
                            <div class="col-md-12 {{ $currentType }}_details" style="display: none">
                                <div class="form-group row ">
                                    <b class="col-md-12 text-primary">Select Account To Redeem Into
                                        &nbsp;
                                        <span class="text-danger"></span> </b>
                                    <select class="form-control col-md-12 accounts-select" id="redeem_account" required>
                                        <option disabled selected value=""> ---
                                            Select
                                            Account ---
                                        </option>
                ...
                <div class="px-md-3 mt-lg-0 rounded">
                    ...
                    <div class="row pt-md-4 mx-auto" style="max-width: 1250px">
                        ...
                        <div class="col-md-8" id="{{ $currentType }}_history_display" style="max-width: 650px;">
                            <div id="{{ $currentType }}_history_container" style="min-height: 350px; " class="mb-3">
