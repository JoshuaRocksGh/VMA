        ...
        <div class="dashboard site-card overflow-hidden">
            ...
            <div class="tab-content dashboard-body border-primary border " id="nav-tabContent">
                <div class="tab-pane fade h-100 show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="tab-content dashboard-body border-primary border " id="nav-tabContent">
                        <div class="tab-pane fade h-100 show active" id="nav-home" role="tabpanel"
                            aria-labelledby="nav-home-tab">
                            <div class="row ">
                                <nav class="d-flex col-sm-2 col-md-auto  align-self-center no-after dashboard-header h-100 align-items-center"
                                    style="height: 100%">
                                    <div class="nav nav-tabs flex-column  border-0" id="nav-tab" role="tablist">
                                        <a href="#canvas_total" data-toggle="tab" data-target="totalsPie"
                                            aria-expanded="false" class="nav-link canvas-tab  mb-2 font-10 active">
                                            <b>Total</b>
                                        </a>
                                        <a href="#canvas_account" data-toggle="tab" data-target="accountsPie"
                                            aria-expanded="false" class="nav-link mb-2 canvas-tab font-10 ">
                                            <b>Accounts</b>
                                        </a>
                                        <a href="#canvas_loan" data-toggle="tab" data-target="loansPie"
                                            aria-expanded="false" class="mb-2  font-10 canvas-tab nav-link">
                                            <b>Loans</b>
                                        </a>
                                        <a href="#canvas_investment" data-toggle="tab" data-target="investmentsPie"
                                            aria-expanded="true" class="mb-2 canvas-tab font-10 nav-link ">
                                    ...
                                    <div class="tab-pane p-0" id="loans">
                                        <div class="table-responsive  loans_display_area">
                                            <table id="loans_table" width="100%"
                                                class="table  display  border rounded mb-0 ">
                                                <thead>
                        ...
                        <div class="tab-pane fade" id="nav_acc_history" role="tabpanel"
                            aria-labelledby="nav_acc_history_tab">

                            <div class="p-2" id="acc_history">
                                <div class="mx-auto mb-4" style="max-width: 650px;"> <strong
